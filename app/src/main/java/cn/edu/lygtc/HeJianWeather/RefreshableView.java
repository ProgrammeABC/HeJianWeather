...
//        View firstChild = listView.getChildAt(0);
        ...
        if (firstChild != null) {
            System.out.println("yes-first!null");
            if (scrollView.getScrollY() == 0) {
                if (!ableToPull) {
                    yDown = event.getRawY();
                }
//                System.out.println("ture:fv:"+firstVisiblePos+"sc:"+firstChild.getTop()+"scrollview y:"+scrollView.getScrollY());
...
//                System.out.println("fv:"+firstVisiblePos+"sc:"+firstChild.getTop()+"scrollview y:"+scrollView.getScrollY());
                ableToPull = false;
            }
...
//            ableToPull = true;
            ...
            System.out.println("yes-first is null");
